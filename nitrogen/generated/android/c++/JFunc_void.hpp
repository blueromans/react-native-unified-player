...
namespace margelo::nitro::unifiedplayer {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/unifiedplayer/Func_void_cxx;";
