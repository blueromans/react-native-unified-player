  ...
  struct JSIConverter<margelo::nitro::unifiedplayer::BufferConfig> final {
    static inline margelo::nitro::unifiedplayer::BufferConfig fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::unifiedplayer::BufferConfig(
        JSIConverter<std::optional<margelo::nitro::unifiedplayer::LivePlaybackParams>>::fromJSI(runtime, obj.getProperty(runtime, "livePlayback")),
        ...
        JSIConverter<std::optional<margelo::nitro::unifiedplayer::Resolution>>::fromJSI(runtime, obj.getProperty(runtime, "preferredMaximumResolution")),
        JSIConverter<std::optional<double>>::fromJSI(runtime, obj.getProperty(runtime, "preferredPeakBitRateForExpensiveNetworks")),
        JSIConverter<std::optional<margelo::nitro::unifiedplayer::Resolution>>::fromJSI(runtime, obj.getProperty(runtime, "preferredMaximumResolutionForExpensiveNetworks"))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::unifiedplayer::BufferConfig& arg) {
      jsi::Object obj(runtime);
      obj.setProperty(runtime, "livePlayback", JSIConverter<std::optional<margelo::nitro::unifiedplayer::LivePlaybackParams>>::toJSI(runtime, arg.livePlayback));
      ...
      obj.setProperty(runtime, "preferredMaximumResolution", JSIConverter<std::optional<margelo::nitro::unifiedplayer::Resolution>>::toJSI(runtime, arg.preferredMaximumResolution));
      ...
      obj.setProperty(runtime, "preferredMaximumResolutionForExpensiveNetworks", JSIConverter<std::optional<margelo::nitro::unifiedplayer::Resolution>>::toJSI(runtime, arg.preferredMaximumResolutionForExpensiveNetworks));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<margelo::nitro::unifiedplayer::LivePlaybackParams>>::canConvert(runtime, obj.getProperty(runtime, "livePlayback"))) return false;
      ...
      if (!JSIConverter<std::optional<margelo::nitro::unifiedplayer::Resolution>>::canConvert(runtime, obj.getProperty(runtime, "preferredMaximumResolution"))) return false;
      ...
      if (!JSIConverter<std::optional<margelo::nitro::unifiedplayer::Resolution>>::canConvert(runtime, obj.getProperty(runtime, "preferredMaximumResolutionForExpensiveNetworks"))) return false;
      return true;
    }
  };
