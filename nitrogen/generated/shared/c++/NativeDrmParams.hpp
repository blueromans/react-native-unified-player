  ...
  struct JSIConverter<margelo::nitro::unifiedplayer::NativeDrmParams> final {
    static inline margelo::nitro::unifiedplayer::NativeDrmParams fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::unifiedplayer::NativeDrmParams(
        ...
        JSIConverter<std::optional<std::function<std::shared_ptr<Promise<std::shared_ptr<Promise<std::string>>>>(const margelo::nitro::unifiedplayer::OnGetLicensePayload&)>>>::fromJSI(runtime, obj.getProperty(runtime, "getLicense"))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::unifiedplayer::NativeDrmParams& arg) {
      ...
      obj.setProperty(runtime, "getLicense", JSIConverter<std::optional<std::function<std::shared_ptr<Promise<std::shared_ptr<Promise<std::string>>>>(const margelo::nitro::unifiedplayer::OnGetLicensePayload&)>>>::toJSI(runtime, arg.getLicense));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<std::function<std::shared_ptr<Promise<std::shared_ptr<Promise<std::string>>>>(const margelo::nitro::unifiedplayer::OnGetLicensePayload&)>>>::canConvert(runtime, obj.getProperty(runtime, "getLicense"))) return false;
      return true;
    }
  };
