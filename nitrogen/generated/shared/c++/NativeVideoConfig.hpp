  ...
  struct JSIConverter<margelo::nitro::unifiedplayer::NativeVideoConfig> final {
    static inline margelo::nitro::unifiedplayer::NativeVideoConfig fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::unifiedplayer::NativeVideoConfig(
        ...
        JSIConverter<std::optional<std::vector<margelo::nitro::unifiedplayer::NativeExternalSubtitle>>>::fromJSI(runtime, obj.getProperty(runtime, "externalSubtitles")),
        JSIConverter<std::optional<margelo::nitro::unifiedplayer::NativeDrmParams>>::fromJSI(runtime, obj.getProperty(runtime, "drm")),
        JSIConverter<std::optional<std::unordered_map<std::string, std::string>>>::fromJSI(runtime, obj.getProperty(runtime, "headers")),
        JSIConverter<std::optional<margelo::nitro::unifiedplayer::BufferConfig>>::fromJSI(runtime, obj.getProperty(runtime, "bufferConfig")),
        JSIConverter<std::optional<margelo::nitro::unifiedplayer::CustomVideoMetadata>>::fromJSI(runtime, obj.getProperty(runtime, "metadata")),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::unifiedplayer::NativeVideoConfig& arg) {
      ...
      obj.setProperty(runtime, "externalSubtitles", JSIConverter<std::optional<std::vector<margelo::nitro::unifiedplayer::NativeExternalSubtitle>>>::toJSI(runtime, arg.externalSubtitles));
      obj.setProperty(runtime, "drm", JSIConverter<std::optional<margelo::nitro::unifiedplayer::NativeDrmParams>>::toJSI(runtime, arg.drm));
      ...
      obj.setProperty(runtime, "bufferConfig", JSIConverter<std::optional<margelo::nitro::unifiedplayer::BufferConfig>>::toJSI(runtime, arg.bufferConfig));
      obj.setProperty(runtime, "metadata", JSIConverter<std::optional<margelo::nitro::unifiedplayer::CustomVideoMetadata>>::toJSI(runtime, arg.metadata));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<std::vector<margelo::nitro::unifiedplayer::NativeExternalSubtitle>>>::canConvert(runtime, obj.getProperty(runtime, "externalSubtitles"))) return false;
      if (!JSIConverter<std::optional<margelo::nitro::unifiedplayer::NativeDrmParams>>::canConvert(runtime, obj.getProperty(runtime, "drm"))) return false;
      ...
      if (!JSIConverter<std::optional<margelo::nitro::unifiedplayer::BufferConfig>>::canConvert(runtime, obj.getProperty(runtime, "bufferConfig"))) return false;
      if (!JSIConverter<std::optional<margelo::nitro::unifiedplayer::CustomVideoMetadata>>::canConvert(runtime, obj.getProperty(runtime, "metadata"))) return false;
