  ...
  struct JSIConverter<margelo::nitro::unifiedplayer::onLoadData> final {
    static inline margelo::nitro::unifiedplayer::onLoadData fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::unifiedplayer::onLoadData(
        ...
        JSIConverter<margelo::nitro::unifiedplayer::VideoOrientation>::fromJSI(runtime, obj.getProperty(runtime, "orientation"))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::unifiedplayer::onLoadData& arg) {
      ...
      obj.setProperty(runtime, "orientation", JSIConverter<margelo::nitro::unifiedplayer::VideoOrientation>::toJSI(runtime, arg.orientation));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<margelo::nitro::unifiedplayer::VideoOrientation>::canConvert(runtime, obj.getProperty(runtime, "orientation"))) return false;
      return true;
    }
  };
